...
<body class="font-sans text-gray-900 antialiased bg-gray-50">
    ...
    <header class="bg-primary-color text-white p-3 flex items-center justify-between mb-4">
        ...
        <button class="bg-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 hover:cursor-pointer" id="menu-btn" >
        ...
        <nav id="menu" class="p-2 fixed right-2 bg-secondary-color w-20 top-15 hidden">
            
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class=" md:text-base text-white font-bold hover:cursor-pointer">Sair</button>
            </form>
    ...
    <nav class="w-full flex border-b-gray-100 border-b font-bold text-sm ">
        ...
        <!-- Perfil -->
        <x-nav-link route="user.index" label="Perfil">
