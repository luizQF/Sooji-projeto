...
<body class="font-sans text-gray-900 antialiased">
    ...
    <header class="bg-primary-color text-white p-5 flex items-center justify-between mb-4">
        ...
        <button class="bg-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 hover:cursor-pointer" id="menu-toggle" >
    ...
    <!-- Menu de navegação -->
    <nav class="w-full flex border-b-gray-100 border-b font-bold text-sm p-1 mb-4">
        <!--Dashboard-->
        <div class="grow border-transparent  border-b-secondary-color hover:border-b-2">
        ...
        <!-- Calendário -->
        <div class="grow border-transparent hover:border-b-secondary-color border-b-2">
            <a href="" class="flex flex-col items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mb-1">
